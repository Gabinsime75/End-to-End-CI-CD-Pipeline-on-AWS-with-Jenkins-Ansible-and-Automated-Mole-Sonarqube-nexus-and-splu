...
pipeline {
    ...
    stage('SonarQube Inspection') {
        steps {
            withSonarQubeEnv('SonarQube') { 
                ...
                -Dsonar.host.url=http://54.147.168.208:9000 \
  ...
  post {
    always {
        ...
        slackSend channel: '#realworld-cicd-pipeline-project', //update and provide your channel name
